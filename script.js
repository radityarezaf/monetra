...
document.getElementById("bookBtn").addEventListener("click", function () {
  ...
  const query = `?name=${encodeURIComponent(name)}&email=${encodeURIComponent(email)}&date=${encodeURIComponent(date)}&people=${people}&phone=${encodeURIComponent(phone)}&total=${total}`;
